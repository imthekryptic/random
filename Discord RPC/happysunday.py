...
while True:
    ...
    if (int((next_sunday_utc - time.time()) / 86400)) > 1:
        ...
        state=f"{int((next_sunday_utc - time.time()) / 86400)} day {int(((next_sunday_utc - time.time()) % 86400) / 3600):02}:{int(((next_sunday_utc - time.time()) % 3600) / 60):02}:{int((next_sunday_utc - time.time()) % 60):02}"
